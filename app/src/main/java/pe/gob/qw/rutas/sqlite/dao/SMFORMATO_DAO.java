...
import pe.gob.qw.rutas.entities.SMFORMATO;
import pe.gob.qw.rutas.sqlite.SQLite;

public class SMFORMATO_DAO {
    private static String NOMBRE_TABLA="SMFORMATO";
    
    public static int Agregar(Context context, SMFORMATO entidad)
   {
       int id = 0;
       ...
       registro.put("iCodFormato",entidad.iCodFormato);
		...
		{           
			try {
				 ...
				 ContentValues registro=new ContentValues();
		            ...
		            registro.put("iCodFormato",json_data.getInt("iCodFormato"));
		            ...
		            registro.put("iValor",json_data.getString("iValor"));   
