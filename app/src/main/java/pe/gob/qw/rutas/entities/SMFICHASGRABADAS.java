...
public class SMFICHASGRABADAS {
    ...
    public String vNombreEstablecimiento;
    public String vCantidadSupervisada;
    public String vCantidadProgramada;
    public String vHoraInicio;
    public String vHoraFin;
    
    public String vCodPostor;
    
    public String vNombresSupervisor;
    public String vApellidosSupervisor;
    public SMMAEFICHAS objSMMAEFICHAS;
    
	public SMFICHASGRABADAS() {
		super();
		this.vTipoVehiculo = "";
		this.vPlaca = "";
		this.vGuiaRemision = "";
		...
		this.vNombresSupervisor="";
		this.vApellidosSupervisor="";
