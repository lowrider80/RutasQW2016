...
import pe.gob.qw.rutas.fragment.FichaRutasVerif1SeccionSlideFragment;
...
public class FichaRutasVerif1SeccionActivity extends FragmentActivity implements LocationListener {
	...
	public static void setIdFicha(int idFicha) {
		FichaRutasVerif1SeccionActivity.idFicha = idFicha;
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lblTitulo.setText("DESCARGA DE PRODUCTOS EN RUTA");

		ll_chkNoAplica = (LinearLayout) findViewById(R.id.ll_chkNoAplica);
		ll_chkNoAplica.setVisibility(View.VISIBLE);
		chkNoAplica=(CheckBox) findViewById(R.id.chkNoAplica);
		chkNoAplica.setVisibility(CheckBox.GONE);
		...
		chkNoAplica.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				...
				SECCIONFICHAGRABADA_DAO.ActualizarEstado( FichaRutasVerif1SeccionActivity.this ,OBJSECCIONFICHAGRABADA);
	...
	private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			return FichaRutasVerif1SeccionSlideFragment.create(position,
					NUM_PAGES,
					NUM_ROWS,
